...
<div id="branding">
    <div class="floatleft logo">
        <img src="img/bd.png" alt="Logo" />
    </div>
    <div class="floatleft middle">
        <h1>Bangladesh Travel Guide</h1>
...
<?php } ?>
    <li class="ic-charts"><a href="theme.php" >&#127912; Themes </a></li>
   <li class="ic-charts"><a href="userlist.php">&#128101; User List</a></li>
    <li class="ic-charts"><a href="postlist.php">&#127760; Visit Website</a></li>
